    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-8">
          {body ? (
            <div className="prose prose-lg max-w-none prose-headings:font-extrabold prose-a:text-brand-blue prose-blockquote:border-l-4 prose-blockquote:border-black prose-code:bg-gray-100 prose-code:px-1 prose-code:rounded prose-li:marker:text-black">
